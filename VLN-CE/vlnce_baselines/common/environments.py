...
@registry.register_env(name="VLNCEDaggerEnv")
...
@registry.register_env(name="VLNCEInferenceEnv")
...
@registry.register_env(name="VLNCEWaypointEnv")
...
@registry.register_env(name="VLNCEWaypointEnvDiscretized")
